...
This is equivalent to minimising the utility $U(w_1,w_2,$ $...w_n,t_1,t_2,...t_T)$ (because $R$ and $T$ are constant). Our optimisation problem is;
\begin{align*}
...
\end{align*}
\footnote{The multiplier $\lambda$ for the loss term corresponds to $C-\frac{1}{T}$}The
