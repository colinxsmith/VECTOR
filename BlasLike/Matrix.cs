...
namespace Blas
{
    public static class Factorise
    {
        ...
        public static int dsptrs(char[] uplo, int n, int nrhs, double[] ap, int[] ipiv, double[] b, int ldb,int astart=0,int pstart=0,int bstart=0)
        {
            int b_dim1, b_offset;
            int j, k;
            double ak, bk;
            ...
            L60:
                ...
                else
                {
                    ...
                    if (k < n - 1)
                    {
                        ...
                        BlasLike.dger(n - k - 1, nrhs, -1, ap/*[kc + n - k + 2]*/, 1, b/*[k +
                            1 + b_dim1]*/, ldb, b/*[k + 2 + b_dim1]*/, ldb,astart+kc+n-k+2,bstart+k+1+b_dim1,bstart+2+b_dim1);
                    }
