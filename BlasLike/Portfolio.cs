    ...
    public class Portfolio
    {
        ...
        {/*
            ...
            for (var i = 0; i < mtrue; ++i)
            {
                ...
                ColourConsole.WriteEmbeddedColourLine($"[red]LAMBDA {LAMBDA[i + n],15:F8}[/red][green] L {L[n + i],12:F8}[/green][cyan] value {cvals[i],12:F8}[/cyan][green] U {U[i + n],12:F8}[/green]");
            }
